...
3. 该方法由`MediaCarouselController$listenForLockscreenSettingChanges$1$3.invokeSuspend(Object)`和`MediaCarouselController`构造函数直接调用，模块会反优化这两个调用方，避免ART内联绕过方法Hook。
